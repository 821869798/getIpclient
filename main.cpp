...
void readNumber()
{
    ...
    ifstream opIndex("start.txt");
    ofstream out("users_r.txt",ios::app);
    //ofstream out("users_r.txt",ios::out);
    int index;
    opIndex>>index;
    opIndex.close();
    string user;
